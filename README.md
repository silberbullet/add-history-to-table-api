...
```
    ...
    - 각각의 배송비 정책은 적용날짜와 종료날짜를 가진다. 등록 시, 종료날짜는  Default로 (9999-12-31 23:59:59) 로 설정한다.
...
| ------ | ----------- | ----------- | ------------------- | -------------------------------------------------------------------- | -------- | ------ |
| 0001   | 01          | 기본 배송비 | 2022-03-01 00:00:00 | <span style="color:red; font-weight:bold">2022-03-07 23:59:59</span> | 1000     | Y      |
